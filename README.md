...
- [Codex as Chief of Staff (Jason Liu)](https://gist.github.com/jxnl/e96b08aae7d01abf99b99f4b1ea9a321) - A lightweight pattern for turning Codex into a personal chief of staff via a local markdown vault as durable memory. Integrates with Slack, Gmail, and GitHub to monitor priorities, track projects, and interrupt only when something genuinely matters — kept deliberately small and practical rather than comprehensive. *(2026-04-16)*
...
- [Building Agents at Home: Homeschooling, Parenting and More (Jesse Genet, a16z)](https://www.youtube.com/watch?v=yiJOTCRVWjc) - Interview with Jesse Genet (founder of Lumi) on using AI agents for homeschooling and family operations — what she calls "agentic parenting." Covers how agents handle curriculum planning, daily routines, and household knowledge work. *(2026-04-13)*
- [ChatPRD/tradclaw](https://github.com/ChatPRD/tradclaw) - OpenClaw starter repo for setting up a household AI assistant that manages daily family operations: calendar briefs, school email triage, meal planning, homework logging, and home maintenance rhythms. Includes optional skills, scheduled job examples, and safety guidelines around child data. *(2026-04-14)*
- [agentic-seo (Addy Osmani, Google)](https://github.com/addyosmani/agentic-seo) - CLI and JS API that audits whether documentation and websites are optimized for AI coding agents. Runs 10 checks across discoverability, content structure, token efficiency, capability signaling, and UX for AI consumption. Auto-detects popular doc frameworks and can scaffold missing optimization files like `llms.txt` and `AGENTS.md`. *(2026-04-11)*
...
- [nowork-studio/NotFair](https://github.com/nowork-studio/NotFair) - Open-source MIT Claude Code skills for SEO, GEO, paid search, and paid social (~2.9k stars). Covers [SEO](https://github.com/nowork-studio/NotFair/tree/main/seo) (site analysis, keyword research, meta tags, schema markup, GEO optimization, content writing), [Google Ads](https://github.com/nowork-studio/NotFair/tree/main/google-ads) (audits, wasted-spend detection, bid management), and [Meta Ads](https://github.com/nowork-studio/NotFair/tree/main/meta-ads) (ROAS analysis, creative fatigue, audience overlap). Connects to live data through the Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP. *(2026-04-11)*
...
- [5 Agent Skills I Use Every Day (Matt Pocock, aihero.dev)](https://www.aihero.dev/5-agent-skills-i-use-every-day) - Five practical Claude Code skills: `/grill-me` (relentlessly interviews you about a plan before writing code, inspired by Brooks' design tree), `/write-a-prd` (turns conversations into PRDs), `/prd-to-issues` (breaks PRDs into vertical-slice GitHub issues), `/tdd`, and `/improve-codebase-architecture`. *(2026-03-16)*
...
- [agent-skills (Addy Osmani, Google)](https://github.com/addyosmani/agent-skills) - 20 production-grade engineering skills for AI coding agents covering the full dev lifecycle: spec, plan, build, test, review, and ship. Grounded in Google engineering practices with anti-rationalization tables that counter agent shortcuts, security/performance checklists, specialist reviewer personas, and verification gates at each stage. *(2026-02-15)*
...
- [andrej-karpathy-skills (Forrest Chang)](https://github.com/forrestchang/andrej-karpathy-skills) - A CLAUDE.md distilling Andrej Karpathy's observations on LLM coding pitfalls into four rules: Think Before Coding, Simplicity First, Surgical Changes, and Goal-Driven Execution. Reduces costly mistakes by enforcing explicit reasoning, discouraging overcomplication, and preventing unrelated edits. *(2026-01-27)*
- [frontend-slides (Zara Zhang, Anthropic)](https://github.com/zarazhangrui/frontend-slides) - Claude Code skill that creates animation-rich HTML presentations from scratch or by converting PowerPoint files. Generates visual style previews for non-designers to choose from, outputs zero-dependency single HTML files, and uses curated design presets to avoid generic AI aesthetics. *(2026-01-28)*
